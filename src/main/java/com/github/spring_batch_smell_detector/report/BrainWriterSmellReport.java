...
@Component
public class BrainWriterSmellReport implements SmellReport {
	...
	public void print(Set<UUID> components, String filePath) {
		try (FileWriter fw = new FileWriter(filePath, true);
			...
			System.out.println("Ocorreu um erro ao tentar gerar o relatório do smell Brain Writer");
			e.printStackTrace();
		}
	}
